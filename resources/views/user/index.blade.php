                                            ...
                                            <div class="col-xxl-3 col-md-4 col-6">
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        ...
                                                        <div class="product-image"><a href="product-detail.html"> <img
                                                                    class="bg-img"
                                                                    src="{{ asset('assets/images/product/product-4/11.jpg') }}"
                                                                    alt="product"></a></div>
                                                        <div class="cart-info-icon"> <a class="wishlist-icon"
                                                                href="javascript:void(0)" tabindex="0"><i
                                                                    class="iconsax" data-icon="heart" aria-hidden="true"
                                            ...
                                            <div class="col-xxl-3 col-md-4 col-6">
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        ...
                                                        <div class="product-image"><a href="product-detail.html"> <img
                                                                    class="bg-img"
                                                                    src="{{ asset('assets/images/product/product-4/12.jpg') }}"
                                                                    alt="product"></a></div>
                                                        <div class="cart-info-icon"> <a class="wishlist-icon"
                                                                href="javascript:void(0)" tabindex="0"><i
                                                                    class="iconsax" data-icon="heart" aria-hidden="true"
                                            ...
                                            <div class="col-xxl-3 col-md-4 col-6">
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        <div class="product-image"><a href="product-detail.html"> <img
                                                                    class="bg-img"
                                                                    src="{{ asset('assets/images/product/product-4/13.jpg') }}"
                                                                    alt="product"></a></div>
                                                        <div class="cart-info-icon"> <a class="wishlist-icon"
                                                                href="javascript:void(0)" tabindex="0"><i
                                                                    class="iconsax" data-icon="heart" aria-hidden="true"
                                            ...
                                            <div class="col-xxl-3 col-md-4 col-6">
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        <div class="product-image"><a href="product-detail.html"> <img
                                                                    class="bg-img"
                                                                    src="{{ asset('assets/images/product/product-4/14.jpg') }}"
                                                                    alt="product"></a></div>
                                                        <div class="cart-info-icon"> <a class="wishlist-icon"
                                                                href="javascript:void(0)" tabindex="0"><i
                                                                    class="iconsax" data-icon="heart" aria-hidden="true"
