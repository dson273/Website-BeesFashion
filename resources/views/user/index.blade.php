...
<!-- Mirrored from themes.pixelstrap.net/katie/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Aug 2024 09:57:10 GMT -->
...
<head>
    ...
    <title>Bee - Bee Fashion Store</title><!-- Favicon icon-->
    <link rel="icon" href="{{asset('images/favicon.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('images/favicon.png')}}" type="image/x-icon"><!-- Google Font Outfit-->
    <link rel="preconnect" href="https://fonts.googleapis.com/">
    <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin="">
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&amp;display=swap" rel="stylesheet">
    <!-- Font Awesome-->
    <link rel="stylesheet" href="{{ mix('css/vendors/fontawesome.css') }}"><!-- Iconsax icon-->
    <link rel="stylesheet" href="{{ mix('css/vendors/iconsax.css') }}"><!-- Bootstrap css-->
    <link rel="stylesheet" id="rtl-link" href="{{ mix('css/vendors/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ mix('css/vendors/swiper-slider/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ mix('css/vendors/toastify.css') }}">

    <link rel="stylesheet" href="{{ mix('css/style.css') }}">
    <script defer src="{{ mix('js/landing_page.js') }}"></script>
    <script defer src="{{ mix('js/style.js') }}"></script>
    <link rel="stylesheet" href="{{ mix('css/landing_page.css') }}">
    <link rel="stylesheet" href="{{ mix('css/style.css') }}">
</head>
...
<body class="skeleton_body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="main-menu"> <a class="brand-logo" href="#"> <img class="img-fluid for-light"
                                    src="{{asset('images/logo/logo.png')}} alt=" logo" /><img class="img-fluid for-dark"
                                    src="{{asset('images/logo/logo-white-1.png')}} alt=" logo" /></a>
                            <nav id="main-nav-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 d-none d-xl-block px-0">
                                                <div class="menu-banner"> <img class="w-100 img-fluid"
                                                        src="{{asset('images/mega-menu/banner.png')}} alt="" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                                    ...
                                                    <div class="mega-menu p-0 overflow-hidden">
                                                        <div class="row gy-4 align-items-center">
                                                            <div class="col-xl-5">
                                                                <div class="mega-img">
                                                                    <div class="img-1"><img class="img-fluid"
                                                                            src="{{asset('images/mega-menu/5.jpg')}}" alt="" /></div>
                                                                    <div class="img-1"><img class="img-fluid"
                                                                            src="{{asset('images/mega-menu/6.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-5"><img class="img-fluid"
                                                                    src="{{asset('images/mega-menu/1.png')}} alt="" /></div>
                                        </div>
                                    </div>
                                </li>
    ...
    <section class="pt-0 home-section-3">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col pe-0">
                    <div class="home-banner p-right"> <img class="img-fluid" src="{{asset('images/layout-3/1.jpg')}}"
                            alt="" />
                        <div class="contain-banner">
                            <div>
            ...
            <ul>
                <li>
                    <div class="service-block"><img
                            src="https://themes.pixelstrap.net/katie/assets/images/svg-icon/1.svg" alt="" />
                        <div>
                ...
                <li>
                    <div class="service-block"><img
                            src="https://themes.pixelstrap.net/katie/assets/images/svg-icon/2.svg" alt="" />
                        <div>
                ...
                <li>
                    <div class="service-block"><img
                            src="https://themes.pixelstrap.net/katie/assets/images/svg-icon/3.svg" alt="" />
                        <div>
                ...
                <li>
                    <div class="service-block border-0"><img
                            src="https://themes.pixelstrap.net/katie/assets/images/svg-icon/4.svg" alt="" />
                        <div>
            ...
            <div class="row">
                    ...
                    <div class="row gy-4 ratio_45">
                        <div class="col-12">
                            <div class="collection-banner p-left"> <img class="bg-img"
                                    src="{{asset('images/banner/banner-7.jpg')}}" alt="" />
                                <div class="contain-banner">
                                    <div>
                                        <h4>Up to 60% OFF</h4>
                        ...
                        <div class="col-12">
                            <div class="collection-banner p-right"><img class="bg-img"
                                    src="{{asset('images/banner/banner-8.jpg')}}" alt="" />
                                <div class="contain-banner">
                                    <div>
                                        <h4>Up to 60% OFF</h4>
                            ...
                            <div class="swiper-wrapper trending-products">
                                <div class="swiper-slide product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image ratio_apos"><a class="pro-first" href="product.html">
                                                <img class="bg-img" src="{{asset('images/product/product-3/5.jpg')}}"
                                                    alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                    class="bg-img" src="{{asset('images/product/product-3/6.jpg')}}"
                                                    alt="product" /></a></div>
                                ...
                                <div class="swiper-slide product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image ratio_apos"><a class="pro-first" href="product.html">
                                                <img class="bg-img" src="{{asset('images/product/product-3/8.jpg')}}"
                                                    alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                    class="bg-img" src="{{asset('images/product/product-3/12.jpg')}}"
                                                    alt="product" /></a></div>
                                        <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                    data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                ...
                <div class="col-4 d-none d-xxl-block">
                    <div class="offer-banner-3 ratio1_3"> <a href="#"> <img class="bg-img"
                                src="{{asset('images/banner/banner-9.jpg')}}" alt="" />
                            <div> <img src="{{asset('images/banner/2.png')}} alt="" />
                                <h6>SALE UP TO 70%</h6>
                            </div>
                        </a></div>
                </div>
                                                            ...
                                                            <div class="product-box-3">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/1.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/11.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/2.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/19.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/3.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/18.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/10.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/21.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/4.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/16.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="product-box-3">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/11.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/15.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/9.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/14.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="product-box-3">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/10.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/13.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="img-wrapper">
                                                                    <div class="label-block"><span class="lable-1">NEW</span><a
                                                                            ...
                                                                            tabindex="0"><i class="iconsax" data-icon="heart" aria-hidden="true"
                                                                                ...
                                                                                data-bs-title="Add to Wishlist"></i></a></div>
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/17.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/1.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                            ...
                                                            <div class="product-box-3">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="product-image"><a class="pro-first" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/18.jpg')}}"
                                                                                alt="product" /></a><a class="pro-sec" href="product.html"> <img
                                                                                class="bg-img" src="{{asset('images/product/product-3/20.jpg')}}"
                                                                                alt="product" /></a></div>
                                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                                            data-bs-target="#addtocart" tabindex="0"><i class="iconsax"
                                                                                data-icon="basket-2" aria-hidden="true" data-bs-toggle="tooltip"
            ...
            <div class="style-banner">
                <div class="row gy-4 align-items-end">
                    <div class="col-sm-6 col-12 ratio_square-4"><a href="collection-left-sidebar.html"> <img
                                class="bg-img" src="{{asset('images/banner/banner-4.png')}} alt="" /></a></div>
                    <div class=" col-sm-6 col-12 ratio3_2">
                            <div class="style-content">
                                ...
                                <div class="link-hover-anim underline"><a
                                    ...
                                    src="{{asset('images/banner/banner-5.jpg')}}" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gy-3">
                ...
                <div class="col-xxl-3 col-lg-6 col-12 order-xxl-1 order-2">
                    <div class="row gy-4">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="flash-content"><img class="img-fluid" src="{{asset('images/banner/6.jpg')}}"
                                    alt="" />
                                <div>
                                    <ul>
                                        <li><svg>
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="flash-content"><img class="img-fluid" src="{{asset('images/banner/7.jpg')}}"
                                    alt="" />
                                <div>
                                    <ul>
                                        <li><svg>
                ...
                <div class="col-xxl-6 col-lg-6 col-12 order-xxl-2 order-1">
                    <div class="flash-images ratio50_2"><a href="collection-left-sidebar.html"><img class="bg-img"
                                src="{{asset('images/banner/banner-10.jpg')}}" alt="" /></a>
                        <div class="banner-2">
                            <h3>40% - 80%Off</h3>
                ...
                <div class="col-xxl-3 col-12 order-xxl-3 order-3">
                    <div class="row gy-4">
                        <div class="col-xxl-12 col-md-6 col-12">
                            <div class="flash-content"><img class="img-fluid" src="{{asset('images/banner/8.jpg')}}"
                                    alt="" />
                                <div>
                                    <ul>
                                        <li><svg>
                        ...
                        <div class="col-xxl-12 col-md-6 col-12">
                            <div class="flash-content"><img class="img-fluid" src="{{asset('images/banner/9.jpg')}}"
                                    alt="" />
                                <div>
                                    <ul>
                                        <li><svg>
                    ...
                    <div class="swiper slide-2">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/1.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/2.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/3.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/4.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/5.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/6.png')}} alt=" logo" /></a></div>
                            <div class="swiper-slide logo-block"><a href="collection-left-sidebar.html"> <img
                                        src="{{asset('images/logos/7.png')}} alt=" logo" /></a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid subscribe-banner">
            <div class="row align-items-center">
                <div class="col-xl-8 col-md-7 col-12 px-0"> <a href="index.html"><img class="bg-img"
                            src="{{asset('images/banner/banner-6.png')}} alt="" /></a></div>
            ...
            <div class="swiper insta-slide-3">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="instagram-box-1">
                            <div class="instagram-box">
                                <div class="instashop-effect"><img src="{{asset('images/instagram/6.jpg')}}" alt="" />
                                    <div class="insta-txt">
                    ...
                    <div class="swiper-slide">
                        <div class="instagram-box-1">
                            <div class="instagram-box">
                                <div class="instashop-effect"><img src="{{asset('images/instagram/7.jpg')}}" alt="" />
                                    <div class="insta-txt">
                                        <div><svg class="insta-icon">
                                                <use
                                                    href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#instagram">
                    ...
                    <div class="swiper-slide">
                        <div class="instagram-box-1">
                            <div class="instagram-box">
                                <div class="instashop-effect"><img src="{{asset('images/instagram/8.jpg')}}" alt="" />
                                    <div class="insta-txt">
                                        <div><svg class="insta-icon">
                                                <use
                                                    href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#instagram">
                    ...
                    <div class="swiper-slide">
                        <div class="instagram-box-1">
                            <div class="instagram-box">
                                <div class="instashop-effect"><img src="{{asset('images/instagram/9.jpg')}}" alt="" />
                                    <div class="insta-txt">
                                        <div><svg class="insta-icon">
                                                <use
                                                    href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#instagram">
                    ...
                    <div class="swiper-slide">
                        <div class="instagram-box-1">
                            <div class="instagram-box">
                                <div class="instashop-effect"><img src="{{asset('images/instagram/10.jpg')}}" alt="" />
                                    <div class="insta-txt">
                                        <div><svg class="insta-icon">
                                                <use
                                                    href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#instagram">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-content">
                            <div class="footer-logo"><a href="index.html"> <img class="img-fluid"
                                        src="{{asset('images/logo/logo-white-1.png')}} alt=" Footer Logo" /></a></div>
                            <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li> <img src="{{asset('images/footer/discover.png')}} alt="" /></li>
                                <li> <img src=" {{asset('images/footer/american.png')}} alt="" /></li>
                                <li> <img src="{{asset('images/footer/master.png')}} alt="" /></li>
                                <li> <img src=" {{asset('images/footer/giro.png')}} alt="" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="quick-view-img">
                                <div class="swiper modal-slide-1">
                                    <div class="swiper-wrapper ratio_square-2">
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/1.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/2.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/3.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/4.jpg')}}"
                                                alt="" /></div>
                                    </div>
                                </div>
                                <div class="swiper modal-slide-2">
                                    <div class="swiper-wrapper ratio3_4">
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/5.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/6.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/7.jpg')}}"
                                                alt="" /></div>
                                        <div class="swiper-slide"><img class="bg-img" src="{{asset('images/pro/8.jpg')}}"
                                                alt="" /></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body modal1">
                        ...
                        <div class="row">
                            <div class="col-12 px-0">
                                <div class="modal-bg addtocart"><button class="btn-close" type="button"
                                    ...
                                    <div class="d-flex"><a href="#"><img class="img-fluid blur-up lazyload pro-img"
                                                src="{{asset('images/modal/0.jpg')}}" alt="" /></a>
                                        <div class="add-card-content align-self-center text-center"><a href="#">
                                            ...
                                            <div class="upsell_payment"><img class="img-fluid blur-up lazyload"
                                                    src="{{asset('images/payment_cart.png')}} alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class=" col-12">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="card-img"> <img src="{{asset('images/modal/1.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Woven Jacket</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                                <div class="card-img"> <img src="{{asset('images/modal/2.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Printed Dresses</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="card-img"> <img src="{{asset('images/modal/3.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Woven Jacket</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                                <div class="card-img"> <img src="{{asset('images/modal/4.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Printed Dresses</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="card-img"> <img src="{{asset('images/modal/5.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Woven Jacket</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                                <div class="card-img"> <img src="{{asset('images/modal/6.jpg')}}" alt="user" /><a href="#">
                                                        <h6>Printed Dresses</h6>
                                                        <p>$25</p>
                                                    </a></div>
                                            </div>
                    ...
                    <div class="offcanvas offcanvas-end shopping-details" id="offcanvasRight" tabindex="-1"
                        ...
                        <div class="offcanvas-body theme-scrollbar">
                            <ul class="offcanvas-cart">
                                <li> <a href="#"> <img src="{{asset('images/cart/1.jpg')}}" alt="" /></a>
                                    <div>
                                ...
                                <li> <a href="#"> <img src="{{asset('images/cart/2.jpg')}}" alt="" /></a>
                                    <div>
                                        <h6 class="mb-0">Shirts Men's Clothing</h6>
                                        <p>$35<del>$40</del><span class="btn-cart">$<span class="btn-cart__total"
                                ...
                                <li> <a href="#"> <img src="{{asset('images/cart/3.jpg')}}" alt="" /></a>
                                    <div>
                                        <h6 class="mb-0">Shirts Men's Clothing</h6>
                                        <p>$35<del>$40</del><span class="btn-cart">$<span class="btn-cart__total"
                                ...
                                <li> <a href="#"> <img src="{{asset('images/cart/4.jpg')}}" alt="" /></a>
                                    <div>
                                        <h6 class="mb-0">Shirts Men's Clothing</h6>
                                        <p>$35<del>$40</del><span class="btn-cart">$<span class="btn-cart__total"
                                ...
                                <div class="row gy-4 ratio_square-2 preemptive-search">
                                        ...
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/1.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                                            <div class="product-detail">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/2.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                                            <div class="product-detail">
                                                <div><a href="product.html">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/3.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                                            <div class="product-detail">
                                                <div><a href="product.html">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/4.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                                            <div class="product-detail">
                                                <div><a href="product.html">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/5.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                                            <div class="product-detail">
                                                <div><a href="product.html">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="product-box-6">
                                            <div class="img-wrapper">
                                                <div class="product-image"><a href="product.html"> <img class="bg-img"
                                                            src="{{asset('images/product/product-2/blazers/6.jpg')}}" alt="product" /></a>
                                                </div>
                                            </div>
                    ...
                    <div class="wrapper">
                        <div class="title-box"> <img src="{{asset('images/other-img/cookie.png')}} alt="" />
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="newslwtter-content"><img class="img-fluid"
                                                        src="{{asset('images/other-img/text.png')}} alt="" />
                                    ...
                                    <div class=" form-floating"><input type="text" placeholder="Enter Your Name.." />
                                        ...
                                        <div class="col-md-6 d-none d-lg-block">
                                            <div class="newslwtter-img"> <img class="img-fluid"
                                                    src="{{asset('images/other-img/news-latter.png')}} alt="" /></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ mix('js/bootstrap/bootstrap.bundle.min.js') }}"></script><!-- iconsax js -->
    <script src="{{ mix('js/iconsax.js') }}"></script><!-- cursor js-->
    <script src="{{ mix('js/stats.min.js') }}"></script>
    <script src="{{ mix('js/cursor.js') }}"></script>
    <script src="{{ mix('js/swiper-slider/swiper-bundle.min.js') }}"></script>
    <script src="{{ mix('js/swiper-slider/swiper-custom.js') }}"></script>
    <script src="{{ mix('js/countdown.js') }}"></script>
    <script src="{{ mix('js/newsletter.js') }}"></script>
    <script src="{{ mix('js/skeleton-loader.js') }}"></script><!-- touchspin-->
    <script src="{{ mix('js/touchspin.js') }}"></script><!-- cookie js-->
    <script src="{{ mix('js/cookie.js') }}"></script><!-- tost js -->
    <script src="{{ mix('js/toastify.js') }}"></script>
    <script src="{{ mix('js/theme-setting.js') }}"></script><!-- Theme js-->
    <script src="{{ mix('js/script.js') }}"></script>
</body>


<!-- Mirrored from themes.pixelstrap.net/katie/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Aug 2024 09:57:17 GMT -->
