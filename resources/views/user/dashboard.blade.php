                                                ...
                                                <div class="col-xl-12">
                                                    <div class="summery-box">
                                                        ...
                                                        <div class="summery-content">
                                                            <ul>
                                                                <li>
                                                                    <p class="fw-semibold">Tổng tiền của sản phẩm (<span
                                                                ...
                                                                <li>
                                                                    <p>Phương thức thanh toán </p><span
                                                                        id="sod_payment_method">vnpay</span>
                                                                </li>
                                                            </ul>
                                                            <ul>
                                                                <li>
                                                                    <p>Phí vận chuyển</p><span
                                                                ...
                                                                <li>
                                                                    <p>Mã giảm giá vận chuyển </p><span class="text-danger"
                                                                        id="sod_shipping_voucher">-123 đ</span>
                                                                </li>
                                                                <li>
                                                                    <p>Mã giảm giá từ cửa hàng </p><span class="text-danger"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        tabs.forEach(tab => {
            tab.addEventListener("click", function() {
                document.getElementById('order_details').classList.remove('show', 'active');
