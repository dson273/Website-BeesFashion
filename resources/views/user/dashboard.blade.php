                                    ...
                                    <div class="notification-tab">
                                        ...
                                        <ul class="notification-body">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="text-center border-top border-bottom mt-3 p-3 bg-of-theme d-flex flex-column">
                                                    <span class="text-white">Cảm ơn bạn đã mua sắm tại cửa hàng của chúng tôi!</span>
                                                    <span class="btn btn-success mt-2" data-bs-toggle="modal" data-bs-target="#confirm-done-order-modal" id="btn_confirm_done_order_2">Đã nhận
                                                        hàng</span>
                                                </div>
                                            </div>
                                                                            ...
                                                                            <tr class="p-5">
                                                                                ...
                                                                                <td class="total fw-bold">
                                                                                    <div class="d-flex flex-column align-items-end">
                                                                                        <span class="fs-6 text-dark {{ 123 != 0 ? 'text-decoration-line-through' : 'fw-bold' }}">321
                                                                                            đ</span>
                                                                                        <span class="fs-6 text-success fw-bold">234
                                                                                            đ</span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
