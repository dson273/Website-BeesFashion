                                                ...
                                                <label for="address-billing-0">
                                                    <div class="delivery-address-box">
                                                        ...
                                                        <span class="address-detail">
                                                            ...
                                                            @csrf
                                                            <button type="submit" class="custom-set-address">Set
                                                                as default</button>
                                                            </form>
                                                        </span>
                                                        @endif
                                                    ...
                                                    <span class="buttons">
                                                        <a class="btn btn_black sm btn_edit_address" href="#"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="email" class="form-control @error('email') is-invalid @enderror" type="email"
                                    name="email" value="{{ Auth::user()->email }}" placeholder="Enter your email.">
                                <div class="invalid-feedback">
                                    @error('email')
                                    {{ $message }}
                                    @enderror
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Holder Name</label><input
                                    class="form-control" type="text" name="name" placeholder="Josephin water..">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Number</label><input
