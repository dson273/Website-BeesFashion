                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="dashboard-left-sidebar sticky">
                        ...
                        <ul class="nav flex-column nav-pills dashboard-tab" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <li>
                                <button class="nav-link" id="notifications-tab" data-bs-toggle="pill" data-bs-target="#notifications" role="tab" aria-controls="notifications" aria-selected="false">
                            ...
                            <li>
                                <button class="nav-link" id="saved-card-tab" data-bs-toggle="pill" data-bs-target="#saved-card" role="tab" aria-controls="saved-card" aria-selected="false">
                                    <i class="iconsax" data-icon="bank-card"></i>
                                    Saved Card
                                </button>
                            </li>
                            <li>
                        ...
                        <div class="col-12">
                            <div class="reviews-product">
                                <div> <img id="product_variant_image_vote_order_detail_modal" src="../assets/images/notification/1.jpg" alt="">
                                    <div>
                                        <h5 class="mb-0" id="product_name_vote_order_detail_modal">Denim Skirts Corset Blazer</h5>
                        ...
                        <div class="col-12">
                            <div class="reviews-product">
                                <div> <img id="review_product_variant_image_vote_order_detail_modal" src="../assets/images/notification/1.jpg" alt="">
                                    <div>
                                        <h5 class="mb-0" id="review_product_name_vote_order_detail_modal">Denim Skirts Corset Blazer</h5>
