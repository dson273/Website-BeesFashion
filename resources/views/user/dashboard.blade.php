                            ...
                            <ul class="nav flex-column nav-pills dashboard-tab" id="v-pills-tab" role="tablist"
                                ...
                                <li>
                                    <button class="nav-link" id="vouchers-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">
                                        <svg fill="#000000" width="21px" data-icon="bank-card" height="21px"
                                        ...
                                        <div class="total-box">
                                            <div class="row gy-4">
                                                <div class="col-xl-4">
                                                    <div class="totle-contain">
                                                        <div class="wallet-point"><img
                                                                src="{{ asset('assets/images/user/wallet.svg') }}"
                                                                alt=""><img class="img-1"
                                                                src="{{ asset('assets/images/user/wallet.svg') }}"
                                                                alt=""></div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="totle-contain">
                                                        <div class="wallet-point"><img
                                                                src="{{ asset('assets/images/user/coin.svg') }}"
                                                                alt=""><img class="img-1"
                                                                src="{{ asset('assets/images/user/coin.svg') }}"
                                                                alt=""></div>
                                                        <div class="totle-detail">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="totle-contain">
                                                        <div class="wallet-point"><img
                                                                src="{{ asset('assets/images/user/order.svg') }}"
                                                                alt=""><img class="img-1"
                                                                src="{{ asset('assets/images/user/order.svg') }}"
                                                                alt=""></div>
                                                        <div class="totle-detail">
                                    ...
                                    <div class="notification-tab">
                                        ...
                                        <ul class="notification-body">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div
                                                    class="text-center border-top border-bottom mt-3 p-3 bg-of-theme d-flex flex-column">
                                                    <span class="text-white">Thank you for shopping at our store!</span>
                                                    <span class="btn btn-success mt-2" data-bs-toggle="modal"
                                                        data-bs-target="#confirm-done-order-modal"
                                                        id="btn_confirm_done_order_2">Đã nhận hàng</span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="custom-container container order-success">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="order-items sticky">
                                                            ...
                                                            <p>Order invoice has been send to your registered email account.
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody id="body_of_list_product">
                                                                            <tr>
                                                                                ...
                                                                                <td class="fw-bold text-success fs-12">321
                                                                                    đ</td>
                                                                                <td>
                                                                                    <div class="d-flex flex-column">
                                                                                        <span
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="6" class="text-center">
                                                                                    <span class="text-danger">Không có dữ
                                                                                        liệu sản phẩm</span>
                                                                                </td>
                                                                            </tr>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="summery-box">
                                                            ...
                                                            <div class="summery-content">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <p>Tax <span>(0,5% of total order value)</span> </p>
                                                                        <span id="sod_tax">123 đ</span>
                                                                    </li>
                                                                    <li>
                                                                        <p>Shipping voucher </p><span class="text-danger"
                                                                ...
                                                                <div class="note-box">
                                                                    <p>I'm hoping the store can work with me to get it
                                                                        ...
                                                                        because
                                                                        I really need it to gift to my friend for her party
                                                                        next week.Many thanks for
                                                                        it.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="summery-footer">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <h6>Expected Date Of Delivery: <span>Track Order</span>
                                                                    </h6>
                                                                </li>
                                                                <li>
                                    ...
                                    <div class="saved-card">
                                        ...
                                        @else
                                            <div class="text-center">
                                                ...
                                                <div>
                                                    <img class="img-fluid"
                                                        src="{{ asset('assets/images/ticket/nullvoucher.png') }}"
                                                        width="450px">
                                                    <div class="text-center mt-3">
                                                        <a href="{{ route('/') }}"
                                                            class="btn btn_black rounded sm">Săn mã ngay</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                ...
                                <div class="dashboard-right-box">
                                    <div class="address-tab">
                                        ...
                                        <button class="btn add-address" data-bs-toggle="modal"
                                            data-bs-target="#add-address" title="Quick View" tabindex="0">+ Thêm
                                            mới</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('full_name') is-invalid @enderror" type="text"
                                        name="full_name" placeholder="Nhập tên đầy đủ của bạn."
                                        value="{{ old('full_name') }}">
                                    @error('full_name')
