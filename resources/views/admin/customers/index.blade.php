    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4 ">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.customers.create') }}" class="btn btn-success text-white text-decoration-none"><i
                        ...
                        <tbody>
                            @foreach ($customers as $key => $customer)
                                <tr>
                                    ...
                                    <td>{{ $customer->role }}</td>
                                    <td>
                                        <a href="{{ route('admin.customers.show', $customer->id) }}">Show</a>
                                        <a href="{{ route('admin.customers.edit', $customer->id) }}">Edit</a>
                                        {{-- <button type="button" class="btn btn-danger btn-sm" onclick="showBanModal({{ $customer->id }})">Mở khóa Khóa
                                        </button> --}}
                                    </td>
                                </tr>
                            @endforeach
