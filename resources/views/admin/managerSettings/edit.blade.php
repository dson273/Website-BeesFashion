    ...
    <div class="card-body">
        <form action="{{ route('admin.managerSettings.update', $managerSetting->id) }}" method="POST">
            ...
            <div class=" mb-3">
                ...
                <input type="text" name="manager_name" value="{{$managerSetting->manager_name}}" class="form-control @error('manager_name') is-invalid @enderror" value="{{ old('manager_name') }}" placeholder="Nhập tên chức năng">
                @error('manager_name')
